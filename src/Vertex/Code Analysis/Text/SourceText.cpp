...
void SourceText::AddLine(Vector<std::shared_ptr<const class TextLine>> &Result, const SourceText &SourceText,
...
std::size_t SourceText::Length() const noexcept { return Text->length(); }
...
std::shared_ptr<const String> SourceText::ToString() const noexcept { return Text; }
