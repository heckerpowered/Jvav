...
TextSpan::TextSpan(const std::size_t Start, const std::size_t Length) noexcept
    : Start(Start), Length(Length) {}

std::size_t TextSpan::End() const noexcept { return Start + Length; }

TextSpan TextSpan::FromBounds(const std::size_t Start,
