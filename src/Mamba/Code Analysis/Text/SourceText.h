...
namespace Mamba
{
    ...
    public:
        ...
        [[nodiscard]] static SourceText
            From(const std::shared_ptr<const String> Text, const std::shared_ptr<const String> FileName = {}) noexcept;

        [[nodiscard]] SourceText(
            const std::shared_ptr<const String> Text,
            const std::shared_ptr<const String> FileName = {}
        ) noexcept;

    private:
        [[nodiscard]] static std::vector<std::shared_ptr<const class TextLine>>
            ParseLines(const SourceText& SourceText, const String& Text) noexcept;
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<String>
            ToString(const std::size_t Start, const std::size_t Length) const noexcept;
